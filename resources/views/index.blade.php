                    ...
                    <div class="text-center text-xxl-start">
                        ...
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                            <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                href="{{ route('main.resume') }}">Resume</a>
                            <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder"
                                href="{{ route('main.projects') }}">Projects</a>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-7">
                    ...
                    <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                        <div class="profile bg-gradient-primary-to-secondary">
                            ...
                            <img class="profile-img " src="{{ asset('assets/assets/imgs/i.png') }}"
                                alt="..." />
                            <div class="dots-1">
                                <!-- SVG Dots-->
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="lead fw-light mb-4">My name is Omar Saeed and I'm A Web Developer.</p>
                        <p class="text-muted">A Junior software engineer who passionated about web development using PHP / Laravel, with ability to build frontend designs</p>
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            <a class="text-gradient" href="https://www.twitter.com/omarbnsaeed" target="_blank"><i class="bi bi-twitter"></i></a>
                            <a class="text-gradient" href="https://www.linkedin.com/in/omarsaeeddev/" target="_blank"><i class="bi bi-linkedin"></i></a>
                            <a class="text-gradient" href="https://www.github.com/omarsaeed7" target="_blank"><i class="bi bi-github"></i></a>
                        </div>
                    </div>
                </div>
            </div>
